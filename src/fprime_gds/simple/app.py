...
# app.py:
#
# This file sets up the PySimpleGUI app, and registers the endpoints for the individual APIs supplied by
# this framework.
#
####
import logging
...
def construct_app():
    ...
    tab_commands_layout = []
    tab_events_layout = []
    tab_telemetry_layout = []

    # The TabgGroup layout - it must contain only Tabs
    tab_group_layout = [[sg.Tab('Commands', tab_commands_layout, key='-COMMANDS-'),
                        sg.Tab('Events', tab_events_layout, key='-EVENTS-'),
                        sg.Tab('Telemetry', tab_telemetry_layout, key='-TELEMETRY-')]]
    ...
    window = sg.Window('F Prime Ground System', layout, no_titlebar=False)
